...
const ptDict = {
  ...
  contact: {
    ...
    errorDesc: "Não foi possível enviar sua mensagem. Tente novamente.",
    consentA: "Li e concordo com a",
    consentLink: "Política de Privacidade",
    consentB: "e autorizo o tratamento dos meus dados conforme a LGPD.",
    errors: {
      ...
      spam: "Spam detectado",
      generic: "Verifique os campos do formulário.",
      tooFast: "Aguarde um instante antes de enviar.",
      cooldown: "Aguarde alguns segundos antes de reenviar.",
    },
  },
  footer: {
    ...
    legal: {
      ...
      terms: "Termos de Uso",
      disclaimer: "Disclaimer Financeiro",
      lgpd: "Canal LGPD",
      security: "Segurança e Privacidade",
    },
    disclaimerA: "As informações disponibilizadas neste site possuem caráter exclusivamente educacional e informativo e não constituem recomendação de investimento, oferta de valores mobiliários ou consultoria financeira individualizada. Leia o",
    disclaimerLink: "Disclaimer Financeiro",
  ...
  cookies: {
    ...
    bodyA: "Utilizamos cookies necessários para o funcionamento do site e, com seu consentimento, cookies analíticos e de marketing para entender o uso e melhorar sua experiência. Saiba mais em nossa",
    ...
    prefsEyebrow: "Preferências de cookies",
    prefsTitle: "Personalize suas preferências",
    save: "Salvar preferências",
    back: "Voltar",
    ariaLabel: "Aviso de cookies",
    rows: {
      necessaryTitle: "Necessários",
      necessaryDesc: "Essenciais para a navegação e funcionalidades básicas. Não podem ser desativados.",
      analyticsTitle: "Analíticos",
      analyticsDesc: "Ajudam a entender como o site é usado (ex.: Google Analytics, Clarity).",
      marketingTitle: "Marketing",
      marketingDesc: "Usados para mensurar campanhas e personalizar comunicações.",
      functionalTitle: "Funcionais",
      functionalDesc: "Permitem recursos adicionais como preferências de idioma e vídeos incorporados.",
    },
  },
};
...
const esDict: Dict = {
  ...
  contact: {
    ...
    errorDesc: "No pudimos enviar tu mensaje. Intentá nuevamente.",
    consentA: "Leí y acepto la",
    consentLink: "Política de Privacidad",
    consentB: "y autorizo el tratamiento de mis datos conforme a la normativa de protección de datos.",
    errors: {
      ...
      consent: "Es necesario aceptar la Política de Privacidad.",
      spam: "Spam detectado",
      generic: "Revisá los campos del formulario.",
      tooFast: "Esperá un instante antes de enviar.",
      cooldown: "Esperá unos segundos antes de reenviar.",
    },
  },
  footer: {
    ...
    legal: {
      ...
      disclaimer: "Disclaimer Financiero",
      lgpd: "Canal de Privacidad",
      security: "Seguridad y Privacidad",
    },
    disclaimerA: "La información disponible en este sitio tiene carácter exclusivamente educativo e informativo y no constituye recomendación de inversión, oferta de valores mobiliarios ni asesoramiento financiero individualizado. Leé el",
    disclaimerLink: "Disclaimer Financiero",
  ...
  cookies: {
    ...
    title: "Usamos cookies",
    bodyA: "Utilizamos cookies necesarias para el funcionamiento del sitio y, con tu consentimiento, cookies analíticas y de marketing para entender el uso y mejorar tu experiencia. Más información en nuestra",
    cookiesLink: "Política de Cookies",
    and: "y",
    ...
    reject: "Rechazar",
    customize: "Personalizar",
    prefsEyebrow: "Preferencias de cookies",
    prefsTitle: "Personalizá tus preferencias",
    save: "Guardar preferencias",
    back: "Volver",
    ariaLabel: "Aviso de cookies",
    rows: {
      necessaryTitle: "Necesarias",
      necessaryDesc: "Esenciales para la navegación y funcionalidades básicas. No pueden ser desactivadas.",
      analyticsTitle: "Analíticas",
      analyticsDesc: "Ayudan a entender cómo se usa el sitio (ej.: Google Analytics, Clarity).",
      marketingTitle: "Marketing",
      marketingDesc: "Usadas para medir campañas y personalizar comunicaciones.",
      functionalTitle: "Funcionales",
      functionalDesc: "Permiten recursos adicionales como preferencias de idioma y videos incrustados.",
    },
  },
};
...
const enDict: Dict = {
  ...
  contact: {
    ...
    errorDesc: "We couldn't send your message. Please try again.",
    consentA: "I have read and agree to the",
    consentLink: "Privacy Policy",
    consentB: "and authorise the processing of my data in accordance with applicable data protection laws.",
    errors: {
      ...
      spam: "Spam detected",
      generic: "Please review the form fields.",
      tooFast: "Please wait a moment before sending.",
      cooldown: "Please wait a few seconds before resending.",
    },
  },
  footer: {
    ...
    legal: {
      ...
      lgpd: "Privacy Channel",
      security: "Security & Privacy",
    },
    disclaimerA: "The information provided on this website is strictly educational and informational in nature and does not constitute an investment recommendation, an offer of securities or individualised financial advice. Read the",
    disclaimerLink: "Financial Disclaimer",
  ...
  cookies: {
    ...
    bodyA: "We use cookies necessary for the website to function and, with your consent, analytics and marketing cookies to understand usage and improve your experience. Learn more in our",
    ...
    prefsTitle: "Customize your preferences",
    save: "Save preferences",
    back: "Back",
    ariaLabel: "Cookie notice",
    rows: {
      necessaryTitle: "Necessary",
      necessaryDesc: "Essential for navigation and core functionality. Cannot be disabled.",
      analyticsTitle: "Analytics",
      analyticsDesc: "Help us understand how the site is used (e.g. Google Analytics, Clarity).",
      marketingTitle: "Marketing",
      marketingDesc: "Used to measure campaigns and personalise communications.",
      functionalTitle: "Functional",
      functionalDesc: "Enable additional features such as language preferences and embedded videos.",
    },
  },
};
